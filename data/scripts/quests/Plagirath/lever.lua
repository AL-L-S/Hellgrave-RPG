...
local player_positions = {
    [1] = {fromPos = Position(31947, 32396, 12), toPos = Position(31948, 32360, 12)},
    [2] = {fromPos = Position(31948, 32396, 12), toPos = Position(31949, 32360, 12)},
    [3] = {fromPos = Position(31949, 32396, 12), toPos = Position(31950, 32360, 12)},
    [4] = {fromPos = Position(31950, 32396, 12), toPos = Position(31951, 32360, 12)}
}

local monsters = {
    [1] = {pos = Position(31949, 32368, 11), name = "Plagirath"}
}
