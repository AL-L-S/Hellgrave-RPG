...
local player_positions = {
    [1] = {fromPos = Position(32010, 32613, 6), toPos = Position(31992, 32625, 9)},
    [2] = {fromPos = Position(32010, 32612, 6), toPos = Position(31992, 32626, 9)},
    [3] = {fromPos = Position(32010, 32611, 6), toPos = Position(31992, 32627, 9)},
    [4] = {fromPos = Position(32010, 32610, 6), toPos = Position(31992, 32628, 9)}
}

local monsters = {
    [1] = {pos = Position(31992, 32622, 9), name = "The Welter"}
}
