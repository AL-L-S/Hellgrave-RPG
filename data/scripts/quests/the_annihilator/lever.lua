local config = {
    cooldown = 60 * 60 * 1, -- in seconds - (Make it 'seconds * minutes * hours' - its will be '60 * 60 * 20' for 20 hours) (player cooldown)
    cooldown_storage = 650005,
...
local player_positions = {
    [1] = {fromPos = Position(32350, 32364, 13), toPos = Position(32337, 32350, 13)},
    [2] = {fromPos = Position(32349, 32364, 13), toPos = Position(32336, 32350, 13)},
    [3] = {fromPos = Position(32348, 32364, 13), toPos = Position(32335, 32350, 13)},
    [4] = {fromPos = Position(32347, 32364, 13), toPos = Position(32334, 32350, 13)}
}

local monsters = {
    [1] = {pos = Position(32335, 32348, 13), name = "Angry Demon"},
    [2] = {pos = Position(32337, 32348, 13), name = "Angry Demon"},
    [3] = {pos = Position(32339, 32348, 13), name = "Angry Demon"},
    [4] = {pos = Position(32341, 32348, 13), name = "Angry Demon"},
    [5] = {pos = Position(32335, 32352, 13), name = "Angry Demon"},
    [6] = {pos = Position(32337, 32352, 13), name = "Angry Demon"},
    [7] = {pos = Position(32339, 32352, 13), name = "Angry Demon"},
    [8] = {pos = Position(32341, 32352, 13), name = "Angry Demon"},
    [9] = {pos = Position(32340, 32350, 13), name = "Angry Demon"},
    [10] = {pos = Position(32341, 32350, 13), name = "Angry Demon"}
}
