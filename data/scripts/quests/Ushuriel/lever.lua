...
local player_positions = {
    [1] = {fromPos = Position(32595, 32115, 13), toPos = Position(32603, 32110, 13)},
    [2] = {fromPos = Position(32595, 32114, 13), toPos = Position(32602, 32110, 13)},
    [3] = {fromPos = Position(32595, 32113, 13), toPos = Position(32601, 32110, 13)},
    [4] = {fromPos = Position(32595, 32112, 13), toPos = Position(32600, 32110, 13)}
}
...
local specs, spec = Game.getSpectators(Position(33919, 31646, 8), false, false, 18, 18, 18, 18)
    for j = 1, #specs do
        spec = specs[j]
        if spec:getName():lower() == 'Ushuriel' then
            spec:remove()
        end
    end
end
